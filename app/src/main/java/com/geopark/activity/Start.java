    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonToRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Start.this, com.geopark.activity.RegisterActivity.class);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Start.this, com.geopark.activity.LoginActivity.class);
                startActivity(intent);
...
//            Intent intent = new Intent(Start.this, com.miriptraveloka2.activity.UsersActivity.class);
//            startActivity(intent);
//            finish();
//
//
